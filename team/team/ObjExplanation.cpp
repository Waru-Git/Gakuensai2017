...
//文字表示-------------------------------------
	...
	Font::StrDraw(L"下移動",375,310,25,moji);
	Font::StrDraw(L"弾発射",375,410,25,moji);
	Font::StrDraw(L"弾回転(右回転)",375,510,25,moji);

	//右機体説明
	Font::StrDraw(L"右機体",530,150,30,moji);
	Font::StrDraw(L"上移動",750,210,25,moji);
	Font::StrDraw(L"下移動",750,310,25,moji);
